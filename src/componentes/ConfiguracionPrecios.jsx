...
export const ConfiguracionPrecios = () => {
    ...
    return (
        <div className="w-full flex flex-col gap-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-3xl p-6 shadow-sm flex flex-col sm:flex-row justify-between items-center gap-4 border border-gray-100 dark:border-gray-700">
                <div>
                    <h2 className="text-3xl font-black text-gray-800 dark:text-white tracking-tight">Panel de Precios</h2>
