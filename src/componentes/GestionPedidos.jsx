                                                ...
                                                >
                                                    ...
                                                    <div className="flex gap-2 mt-2">
                                                        {pedido.estado === 'sin_iniciar' && (
                                                            <button onClick={(evento) => avanzarEstado(pedido, evento)} className="flex-1 py-1.5 bg-yellow-100 hover:bg-yellow-200 dark:bg-yellow-900/40 text-yellow-700 dark:text-yellow-400 text-[10px] font-black uppercase rounded-lg border border-yellow-200 dark:border-yellow-800 transition-colors">▶ Iniciar</button>
                                                        )}
                                                        {pedido.estado === 'iniciado' && (
                                                            <button onClick={(evento) => avanzarEstado(pedido, evento)} className="flex-1 py-1.5 bg-green-100 hover:bg-green-200 dark:bg-green-900/40 text-green-700 dark:text-green-400 text-[10px] font-black uppercase rounded-lg border border-green-200 dark:border-green-800 transition-colors">✔ Terminar</button>
                                                        )}
                                                    </div>
                                                </div>
                                            )
